...
model.head[6] = nn.Linear(1280, 10).to(device)
...
log_path = f"/media/rob/hdd1/james-gj/finetune_efficientnet_cifar10/{exp_name}"
...
if __name__ == "__main__":
    ...
    if will_train:
        ...
        # issue, i.e. 20/20 = 1, as does 400/400, but that doesn't mean there were 400 images trained with in the epoch.
    ...
    if will_train:
        ...
        if not checkpoints:
            ...
            model_path = f"efficientNet_cifar10_{scores[best_epoch]}.pt"
